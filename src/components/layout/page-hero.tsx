...
export function PageHero({ eyebrow, title, description, aside }: { eyebrow: string; title: string; description: string; aside?: ReactNode }) {
  return (
    <section className="surface-grain relative overflow-hidden border-b border-sky-200/10 bg-forest-950 text-white">
      ...
      <div className="absolute right-[7%] bottom-[-12rem] size-72 rounded-full border border-sky-200/15 sm:size-[30rem]" />
      ...
      <div className="waterline absolute inset-x-0 bottom-0 h-px" />
